...
const _slideDua = function () {
  ...
  setTimeout(function () {
    slideSatu.classList.replace('animate__fadeIn', 'animate__fadeOut');
  ...
  setTimeout(function () {
    tap.classList.remove('d-none');
    document.body.addEventListener('click', function () {
      slideDua.classList.replace('animate__fadeIn', 'animate__fadeOut');
...
const _slideTiga = function () {
  ...
  setTimeout(function () {
    ...
    document.body.addEventListener('click', function () {
      ...
      slideTiga.classList.replace('animate__fadeIn', 'animate__fadeOut');
      tap.remove();
      setTimeout(function () {
        slideTiga.remove();
        _slideEmpat();
...
const _slideEmpat = function () {
  ...
  slideEmpat.classList.replace('animate__fadeIn', 'animate__fadeOut');
  slideEmpat.classList.remove('animate__delay-2s');

  setTimeout(function () {
    slideEmpat.remove();

    // 🔥 SHOW FEEDBACK INSTEAD OF SLIDE LIMA
...
new TypeIt("#teks1", {
  strings: ["Today, I send all my best prayers to the sky for you.", "May the things that make you fall also be the reason for you to keep growing.", "May the world always protect you wherever you are.", "May your days always be accompanied by boundless love.", "May every step you take be eased until you achieve what you desire."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["With or without me, may the universe always make you happy in any way.", " ", "Happy birthday, thank you for surviving this far.", " ", "- Wish you all the best"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true,
...
>>>>>>> 559dff43826e6bcfce22e9a346e48abcde26c749
